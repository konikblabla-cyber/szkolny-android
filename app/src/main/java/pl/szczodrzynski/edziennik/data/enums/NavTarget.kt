...
enum class NavTarget(
    ...
    HELP(
        id = 29,
        fragmentClass = AximoHelpFragment::class.java,
        location = NavTargetLocation.NOWHERE,
        nameRes = R.string.menu_help,
        titleRes = R.string.menu_help,
        icon = CommunityMaterial.Icon2.cmd_help_circle_outline,
    ),
    ABOUT(
        id = 30,
        fragmentClass = AximoAboutFragment::class.java,
        location = NavTargetLocation.NOWHERE,
        nameRes = R.string.menu_about_aximo,
        titleRes = R.string.menu_about_aximo,
        icon = CommunityMaterial.Icon2.cmd_help_circle_outline,
    ),
    APPEARANCE(
        id = 27,
        ...
        location = NavTargetLocation.NOWHERE,
        nameRes = R.string.menu_appearance_aximo,
        titleRes = R.string.menu_appearance_aximo,
        icon = CommunityMaterial.Icon.cmd_cog_outline,
    ),
    SILENCE(
        id = 26,
        fragmentClass = AximoSilenceFragment::class.java,
        location = NavTargetLocation.NOWHERE,
    ...
    MORE(
        id = 25,
        fragmentClass = AximoMoreFragment::class.java,
        location = NavTargetLocation.NOWHERE,
