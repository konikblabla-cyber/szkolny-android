    ...
    fun setAppBackground() {
        try {
            ...
            val colors = when (background) {
                ...
                "forest" -> intArrayOf(0xFF06140F.toInt(), 0xFF103A2B.toInt(), 0xFF0B1820.toInt())
                "rain" -> intArrayOf(0xFF070E1A.toInt(), 0xFF172B43.toInt(), 0xFF101A2C.toInt())
                "ember" -> intArrayOf(0xFF180807.toInt(), 0xFF4A2114.toInt(), 0xFF21101A.toInt())
                "lavender" -> intArrayOf(0xFF100A1F.toInt(), 0xFF2A1A46.toInt(), 0xFF17152F.toInt())
